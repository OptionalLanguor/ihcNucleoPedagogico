...
<div class="w3-main" style="margin-left:340px;width: 70%">
  ...
  <div class="w3-container" style="margin-top:40px" id="novoaluno">
    <h1 class="w3-jumbo"><b>Cadastro de Procedimento</b></h1>
  </div>

  <!-- Insercao -->
  <div class="w3-container" id="criacao" >
    <h1 class="w3-xxxlarge w3-text-indigo"><b>Criação de novo Procedimento</b></h1>
    <hr style="width:50px;border:5px solid #3f51b5" class="w3-round">

    <?php echo form_open('Cadastrar_procedimento/Cadastrar'); ?>
    ...
    <?php
      ...
      <button type="submit" class="w3-button w3-block w3-padding-large w3-indigo w3-margin-bottom">Criar Procedimento</button>
    </form>
  </div>
